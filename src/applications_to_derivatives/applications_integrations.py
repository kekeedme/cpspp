...
def heatcapacity(temperature):
    ...
    integral_result = gaussquad(polynomial,0,upperbound,50) # performing integration for N=50
    heatcapacityval = 9 * RHO * VOLUME * KBOLTZMAN * ((temperature/THETA)**3) * integral_result
